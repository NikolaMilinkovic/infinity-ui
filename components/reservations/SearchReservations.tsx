...
function SearchReservations({ searchData, setSearchData, updateSearchParam, isDatePicked, setIsDatePicked, setPickedDate }: PropTypes) {
  ...
  useBackClickHandler(isExpanded, handleToggleExpand);
    ...
    async function handleFetchReservationsByDate(date: Date, token: any){
      ...
      if(response === false) popupMessage('Došlo je do problema prilikom preuzimanja podataka o rezervacijama', 'danger');
