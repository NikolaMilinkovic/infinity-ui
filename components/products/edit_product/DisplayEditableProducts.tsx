...
import DisplayEditProduct from './DisplayEditProduct';

interface PropTypes {
  setEditedProduct: (data: ProductTypes | null) => void;
}

function DisplayEditableProducts({ setEditedProduct }: PropTypes) {
...
export default DisplayEditableProducts