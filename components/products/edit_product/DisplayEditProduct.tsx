...
interface DisplayEditProductProps {
  item: ProductType;
  setEditedProduct: (data: ProductType | null) => void;
}

function DisplayEditProduct({ item, setEditedProduct }: DisplayEditProductProps) {
...
export default DisplayEditProduct